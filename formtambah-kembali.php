...
// var_dump ($_POST);
// var_dump INI UNTUK MELIHAT APAKAH DATA ADA YANG DINPUTKAN PADA VARIABEL POSTTERSEBUT


//Cek pesan berhasil disimpan atau tidak if (tambah($_POST) > 0 ) {
    if (tambah4($_POST) > 0 ) {
...
document.location.href='tables-kembali.php';
</script> ";
...
document.location.href='formtambah-kembali.php';
</script> ";
...
<html
  ...
  <head>
    ...
    <title>Forms | Tambah Data Kembali</title>
      ...
      <div class="layout-container">
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Form/</span> Tambah Data</h4>
                    ...
                    <div class="card-body">
                      <form action="" method="post" enctype="multipart/form-data">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="nis" class="form-control" id="nis" placeholder="Input NIS" > 
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="tgl_kembali">Tanggal Kembali</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
                              name="tgl_kembali"
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="kode_buku" class="form-control" id="kode_buku" placeholder="Input Kode Buku" > 
                          </div>
                        </div>
                        <div class="row mb-3">
