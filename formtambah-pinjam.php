...
document.location.href='tables-pinjam.php';
</script> ";
...
document.location.href='formtambah-pinjam.php';
</script> ";
...
<html
  ...
  <head>
    ...
    <title>Forms | Tambah Data Pinjam</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="tgl_pinjam">Tanggal Pinjam</label>
                          <div class="col-sm-10">
                            <input
                              type="date"
                              name="tgl_pinjam"
