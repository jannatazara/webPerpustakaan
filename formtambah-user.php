...
document.location.href='formtambah-user.php';
</script> ";
...
<html
  ...
  <head>
    ...
    <title>Forms | Tambah Data User</title>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="" method="post" >
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="kode_buku">Konfirmasi Password</label>
                          <div class="col-sm-10">
