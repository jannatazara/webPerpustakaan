...
$jml_data = count(query("SELECT 8 FROM tbl_buku"));
...
$siswa = query ("SELECT * from tbl_buku LIMIT $data_awal,
$jml_data_perhalaman");
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Buku</h4>
              
              <!-- Bordered Table -->
              <div class="card">
                <h4 class="card-header">Tabel Buku</h4>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                  <a href="formtambah-buku.php">Tambah Data</a><br>
                  <a href="cetaklaporan-buku.php">Cetak Laporan Buku</a>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="ubah-buku.php?Id=<?= $row["Id"];?>"
                                  ><i class="mdi mdi-pencil-outline me-1"></i> Ubah</a
                                >
                                <a class="dropdown-item" href="hapus-buku.php?Id=<?= $row["Id"];?>"
