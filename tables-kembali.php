...
$jml_data = count(query("SELECT 8 FROM tbl_kembali"));
...
$siswa = query ("SELECT * from tbl_kembali LIMIT $data_awal,
$jml_data_perhalaman");


//Tombol Cari di klik
if (isset ($_POST["cari"]) ) {
    $siswa= cari4($_POST["keyword"]);
...
<html
  ...
  <head>
    ...
    <title>Tables | Tabel Kembali</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Kembali</h4>
              <!-- Bordered Table -->
              <div class="card">
                <h4 class="card-header">Tabel Kembali</h4>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                  <a href="formtambah-kembali.php">Tambah Data</a><br>
                  <a href="cetaklaporan-kembali.php">Cetak Laporan Kembali</a>
                         ...
                         <tr>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="ubah-kembali.php?Id=<?= $row["Id"];?>"
                                  ><i class="mdi mdi-pencil-outline me-1"></i> Ubah</a
                                >
                                <a class="dropdown-item" href="hapus-kembali.php?Id=<?= $row["Id"];?>"
