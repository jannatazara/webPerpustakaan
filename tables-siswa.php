...
$jml_data = count(query("SELECT 8 FROM tbl_siswa"));
...
$siswa = query ("SELECT * from tbl_siswa LIMIT $data_awal,
$jml_data_perhalaman");
...
<html
  ...
  <head>
    ...
    <title>Tables | Tabel Siswa</title>
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y" >
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Tables /</span> Data Siswa</h4>
              <!-- Bordered Table -->
              <div class="card">
                <h4 class="card-header">Tabel Siswa</h4>
                 <div class="card-body">
                  <div class="table-responsive text-nowrap">
                  <a href="formtambah-siswa.php">Tambah Data</a><br>
                  <a href="cetaklaporan-siswa.php">Cetak Laporan Siswa</a>
                          ...
                          <td><?=$i;?></td>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="ubah-siswa.php?Id=<?= $row["Id"];?>"
                                  ><i class="mdi mdi-pencil-outline me-1"></i> Ubah</a
                                >
                                <a class="dropdown-item" href="hapus-siswa.php?Id=<?= $row["Id"];?>"
