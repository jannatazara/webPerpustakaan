...
$jml_data = count(query("SELECT 8 FROM tbl_user"));
...
$siswa = query ("SELECT * from tbl_user LIMIT $data_awal,
$jml_data_perhalaman");

//Tombol Cari di klik
if (isset ($_POST["cari"]) ) {
    $siswa= cari5($_POST["keyword"]);
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Bordered Table -->
              <div class="card">
                <h4 class="card-header">Tabel User</h4>
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                  <a href="formtambah-user.php">Tambah Data</a><br>
                  <a href="cetaklaporan-user.php">Cetak Laporan User</a>
                         ...
                         <tr>
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="ubah-user.php?Id=<?= $row["Id"];?>"
                                  ><i class="mdi mdi-pencil-outline me-1"></i> Ubah</a
                                >
                                <a class="dropdown-item" href="hapus-user.php?Id=<?= $row["Id"];?>"
