...
$siswa = query("SELECT * FROM tbl_kembali WHERE Id = $Id ")[0];
...
<html
  ...
  <head>
    ...
    <title>Forms | Ubah Data Kembali</title>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="tgl_kembali">Tangal Kembali</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="date" name="tgl_kembali" id="tgl_kembali" class="form-control" value="<?= $siswa["tgl_kembali"]; ?>" />
                            </div>
                          </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="kode_buku">Kode Buku</label>
                          <div class="col-sm-10">
                            <input type="text" name="kode_buku" class="form-control" id="kode_buku" value="<?= $siswa["kode_buku"]; ?>"> 
                          </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="keterangan">Keterangan</label>
                          <div class="col-sm-10">
                            <input type="text" name="keterangan" class="form-control" id="keterangan" value="<?= $siswa["keterangan"]; ?>"> 
                          </div>
                    </div>
