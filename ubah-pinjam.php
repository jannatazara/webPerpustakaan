...
$siswa = query("SELECT * FROM tbl_pinjam WHERE Id = $Id ")[0];
...
<html
  ...
  <head>
    ...
    <title>Forms | Ubah Data Pinjam</title>
                        ...
                        <label class="col-sm-2 col-form-label" for="tgl_pinjam">Tanggal Pinjam</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <input type="date" name="tgl_pinjam" id="tgl_pinjam" class="form-control" value="<?= $siswa["tgl_pinjam"]; ?>" />
                            </div>
                          </div>
                    </div>
                    <div class="row mb-3">
